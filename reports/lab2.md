...
## 1. В репозитории были созданы папки для лабораторных работ по "Структурам данных".
```
mkdir cpplabs
cd cpplabs
mkdir lab1
...
3. Установить правило для ветки: *Add classic branch protection rule* 
4. Для ветки main установить защиту: *Require a pull request before merging*
   
## 4. Проверка
### На ветке main вносим изменения, теперь при попытке сделать **push** на main git bash предупреждает:
```
$ git push
...
### Вносим изменения, на GitHub делаем **Pull Request**.
