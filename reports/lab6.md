...
Настройте в вашей копии хук, который будет создавать html-версию вашего отчета из md-файла по последней версии из указанной ветки (например, lab6).
Отобразите html-файл в браузере, сделайте push в нужную ветку, убедитесь, что html-файл корректно отображается и обновляется при отправки изменений в репозиторий.